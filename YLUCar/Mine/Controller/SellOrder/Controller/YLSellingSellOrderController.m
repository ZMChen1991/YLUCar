//
//  YLSellingSellOrderController.m
//  YLUCar
//
...
#define YLSellingSaleOrderPath [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"SellingSaleOrder.txt"]

@interface YLSellingSellOrderController ()

@property (nonatomic, strong) NSMutableArray *saleOrders;
@property (nonatomic, strong) YLNoneView *noneView;
@end

@implementation YLSellingSellOrderController
...
- (void)loadData {
    ...
    [YLRequest GET:urlString parameters:param success:^(id  _Nonnull responseObject) {
        if ([responseObject[@"code"] isEqualToNumber:[NSNumber numberWithInteger:200]]) {
            [weakSelf keyedArchiverObject:responseObject toFile:YLSellingSaleOrderPath];
...
- (void)getLocalData {
    ...
    [self.saleOrders removeAllObjects];
    NSDictionary *dict = [NSKeyedUnarchiver unarchiveObjectWithFile:YLSellingSaleOrderPath];
