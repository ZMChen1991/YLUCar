...
@interface YLDepreciateCellFrame : NSObject

@property (nonatomic, strong) YLDepreciateModel *model;
...
@property (nonatomic, assign) CGRect depreciateF;
