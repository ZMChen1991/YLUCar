//
//  YLCollectionSoldOutController.m
//  YLUCar
//
...
#define YLCollectionSoldOutPath [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"CollectionSoldOut.txt"]

@interface YLCollectionSoldOutController ()
...
@implementation YLCollectionSoldOutController
...
- (void)loadData {
    ...
    [YLRequest GET:urlString parameters:param success:^(id  _Nonnull responseObject) {
        if ([responseObject[@"code"] isEqualToNumber:[NSNumber numberWithInteger:200]]) {
            [weakSelf keyedArchiverObject:responseObject toFile:YLCollectionSoldOutPath];
...
- (void)getLocalData {
    ...
    NSDictionary *dict = [NSKeyedUnarchiver unarchiveObjectWithFile:YLCollectionSoldOutPath];
