...
#import "YLSaleCarSeriesController.h"
#import "YLRequest.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    YLBrandModel *brandModel = self.brands[indexPath.section][indexPath.row];
    YLSaleCarSeriesController *series = [[YLSaleCarSeriesController alloc] init];
    series.model = brandModel;
    series.seriesBlock = ^(YLSeriesModel * _Nonnull seriesModel, YLCarTypeModel * _Nonnull carTypeModel) {
        if (self.brandBlock) {
            self.brandBlock(brandModel, seriesModel, carTypeModel);
        }
    };
