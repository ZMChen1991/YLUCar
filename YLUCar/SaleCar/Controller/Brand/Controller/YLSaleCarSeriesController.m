...
@interface YLSaleCarSeriesController ()

@property (nonatomic, strong) NSArray *series;

@end

@implementation YLSaleCarSeriesController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    YLSeriesModel *seriesModel = self.series[indexPath.row];
    YLSaleCarTypeController *carType = [[YLSaleCarTypeController alloc] init];
    carType.seriesModel = seriesModel;
    carType.carTypeBlock = ^(YLCarTypeModel * _Nonnull carTypeModel) {
        if (self.seriesBlock) {
            self.seriesBlock(seriesModel, carTypeModel);
        }
    };
